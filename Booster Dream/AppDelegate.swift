...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
        ...
        STPPaymentConfiguration.shared().publishableKey = "pk_test_gqehE2J5Z2EexElwvwxFlzgG"
        
        let config = ParseClientConfiguration {
            $0.applicationId = "dUYm7SoFmn4w6ImUIwbRKiDrjcNWhERwzPeY0hrC"
            $0.clientKey = "VUDyImaqTEozZVnnyADhhEZtIQRTwNod3fwOuryA"
            $0.server = "https://parseapi.back4app.com"
        }
        Parse.initialize(with: config)
        saveInstallationObject()
        
//        if let _ = DBUser.current() {
//
